...
exports.command = {
    ...
    async run(interaction, options, client) {
        ...
        const embed = new discord_js_1.MessageEmbed()
            ...
            .setColor('RANDOM')
            .addFields({ name: 'Name', value: interaction.guild.name, inline: true }, { name: 'ID', value: `${interaction.guild.id}`, inline: true }, { name: '\u200b', value: '\u200b', inline: true }, {
            name: 'Verification Level',
            value: verificationLevel.slice(0, 1).toUpperCase() +
            ...
            value: `${interaction.guild.memberCount} | ${members.filter((member) => !member.user.bot).size} | ${members.filter((member) => member.user.bot).size}`,
            inline: true,
