...
export const categories: { name: string; description: string; guildId: string; categoryId: string; ping: string; emoji: EmojiResolvable }[] = [
	...
	{
		name: 'Partnership',
		description: 'Choose this option if you have a server and want to partner with us. Be sure to read the requirements before requesting partering.',
		guildId: '831995980097388604',
	...
	{
		name: 'Appeal',
		description: 'Choose this option if you feel like a punishment that was given to you was unfair or biased. A head moderator or above will handle your request, so please be patient. Remember, Automod are **NOT** appealable.',
		guildId: '831995980097388604',
	...
	{
		name: 'Developers',
		description: 'For any questions you have towards our bot developers, for example bug reports. This is **NOT** for general questions.',
		guildId: '831995980097388604',
...
export const event: Event = {
	...
	async run(client, message: Message) {
		...
		if (modmail) {
			...
			/** Handled by selectMenuInteraction.ts */
		}
	},
};